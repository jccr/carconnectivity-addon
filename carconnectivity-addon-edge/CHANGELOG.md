...
- **CarConnectivity-connector-seatcupra** → v0.6.1a3
...
- **CarConnectivity-connector-seatcupra** → v0.6.1a2
...
- **CarConnectivity-connector-volkswagen-na** → [v0.1.15-b.2](https://github.com/zackcornelius/CarConnectivity-connector-volkswagen-na.git)
...
- **CarConnectivity-connector-volkswagen-na** → [v0.1.15-b.1](https://github.com/zackcornelius/CarConnectivity-connector-volkswagen-na.git)
...
- **CarConnectivity-connector-volkswagen-na** → [v0.1.14-beta.2](https://github.com/zackcornelius/CarConnectivity-connector-volkswagen-na.git)
...
- **CarConnectivity-connector-skoda** → [v0.11.6a2](https://github.com/tillsteinbach/CarConnectivity-connector-skoda.git)
...
- **CarConnectivity-connector-skoda** → [v0.11.6a1](https://github.com/tillsteinbach/CarConnectivity-connector-skoda.git)
...
- **CarConnectivity-connector-volkswagen** → [v0.9.2a2](https://github.com/tillsteinbach/CarConnectivity-connector-volkswagen.git)
...
- **CarConnectivity-connector-volkswagen** → [v0.9.2a1](https://github.com/tillsteinbach/CarConnectivity-connector-volkswagen.git)
...
- **CarConnectivity-connector-skoda** → [v0.9a1](https://github.com/tillsteinbach/CarConnectivity-connector-skoda.git)
...
- **CarConnectivity-plugin-webui** → [v0.5.3a1](https://github.com/tillsteinbach/CarConnectivity-plugin-webui.git)
...
- **CarConnectivity-connector-skoda** → [v0.8.1a2](https://github.com/tillsteinbach/CarConnectivity-connector-skoda.git)
